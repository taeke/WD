...
namespace WDGameEngine.Interfaces
{
    ...
    public interface IGame
    {
        ...
        /// <summary>
        /// Handler for a change in <see cref="Country"/> for a IPlayer. 
        /// </summary>
       ...
       /// <summary>
        ...
        /// <param name="country"> The <see cref="Country"/> the <see cref="IPlayer"/> want to place his armies on. </param>
        ...
        /// </summary>
        /// <param name="attacker"> The <see cref="Country"/> the currentPlayer wants to launch his attack from. </param>
        /// <param name="defender"> The <see cref="Country"/> the currentPlayer wants to attack. </param>
        ...
        /// </summary>
        /// <param name="from"> The <see cref="Country"/> to move the armies from. </param>
        /// <param name="to"> The <see cref="Country"/> to move the armies to. </param>
